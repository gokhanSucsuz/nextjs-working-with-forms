    ...
    return (
        <div className='p-10'>
            ...
            <form className="max-w-sm mx-auto p-10 border shadow-lg rounded-lg" action={handleAction}>
                <h1 className='pb-5 text-xl font-bold text-center text-green-600'>Zod Package Validation Server</h1>
                <div className="mb-5">
                ...
                <div className="mb-5">
                    ...
                    <input name='rePassword' type="password" id="repeat-password" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" />
